  ...
  <form action="" class="AI_form">
    <div class="inputbox_design">
      <div class="AI_search_container">
        <select class="AI_search_select" placeholder="여행지를 선택해주세요.">
          <option value="성별">지역</option>
          <option value="성별">명동</option>
          <option value="성별">종로</option>
          <option value="성별">한강</option>
          <option value="성별">강남</option>
          <option value="성별">동대문</option>
        </select>
